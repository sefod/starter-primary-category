...
Installing "SD Primary Categories" can be done either by searching for "SD Primary Categories" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
