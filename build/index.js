...
(function (wp) {
  ...
  var MetaBlockField = compose(withDispatch(function (dispatch, props) {
    return {
      setMetaFieldValue: function setMetaFieldValue(value) {
        dispatch('core/editor').editPost({
          meta: {
            _sd_primary_cat: value
          }
        });
      }
    };
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Text, {
  ...
  registerPlugin('my-plugin-panel', {
    render: function render() {
      ...
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(MetaBlockField, {
